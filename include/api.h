...
#define QKD_STATUS_PEER_DISCONNECTED       1  /* Successful connection, peer not connected */
...
#define QKD_STATUS_METADATA_SIZE_ERROR     8  /* GET_KEY failed: metadata size insufficient */
...
struct qkd_backend {
    ...
    uint32_t (*open_connect)(const char* source, 
